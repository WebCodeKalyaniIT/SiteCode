		...
		<div class="row text-center">
				...
				<a href="overview.php" class="portfolio-link">
					<div class="col-md-12 hoverstyle standout wow fadeInLeft animated">
						...
						<h4 class="service-heading">Numeric Overview</h4>
						<p class="text-muted">
							Numeric Technologies provides Enterprise Solutions with a prime focus on ERP, Big-Data, Dashboard & Analytics, E-Commerce, 
				...
				<a href="leadership.php" class="portfolio-link">
					<div class="col-md-12 hoverstyle standout wow fadeInLeft animated">
						...
						<h4 class="service-heading">Numeric Leadership</h4>
						<p class="text-muted">
							...
							At Numeric we are lucky to have the most visionary leadership.
					 </p>
 					</div>
				</a>
				<a href="advantage.php" class="portfolio-link">
					<div class="col-md-12 hoverstyle standout wow fadeInLeft animated">
						...
						<h4 class="service-heading">Numeric Advantage</h4>
						<p class="text-muted">
