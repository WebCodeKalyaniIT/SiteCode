...
<head>
    ...
    <title>Kalyani IT | BIG-DATA</title>
...
?>	
	...
	<div class="breadcrumb-wrapper">
		...
		<ol class="breadcrumb">
			...
			<span class="breadcrumb_last">Big-Data Solutions</span></span></span></span>
			</li>
		</ol>
		</div>
	</div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="col-md-12"><br>
								<h3>BIG-DATA SOLUTIONS</h3><br> 
								<img src="img/bigdata.png">
								 <div class="spacer-30"></div>
								<h4 class="service-heading">Kalyani IT SAP & ERP Expertise</h4>
								<p>Kalyani IT has extensive SAP/ERP experience having worked for some of the most demanding, prestigious, distinguished organizations in the world. Our SAP resources are among the best in the business. We offer cloud, on-premise and hybrid deployment options to provide more choice to our diverse group of customers. Some benefits include: a smaller data footprint, higher throughput, faster analytics and reports, SAP HANA Cloud Platform extension, multitenancy, and faster access to data. It also allows existing SAP Business Suite customers to upgrade to this product instead of re-implementing</p>
								<p>Included are just some of the areas in SAP that Kalyani IT specializes in;</p>
									...
									<p>Kalyani IT can help design, develop, integrate and support your enterprise data systems. We can work on full life cycle projects, or provide supplemental resources to existing projects. We are able to provide the scalability, flexibility and experience to ensure execution excellence.3/jquery</p>
									<div class="spacer-20"></div>	
									<h4 class="service-heading">Kalyani IT's BIG - DATA Expertise</h4>
									...
									<p>Kalyani IT's approach to BIG-DATA is to be as well versed and experienced in the latest tools, products and technologies to ensure that our clients' need are met and that their data is accessible, accelerated and at a reduced cost than what other can offer. Our experienced data scientist utilize multiple flavors of Big-Data tools in order to acheive maximum results, based on the amount and type of data involved. Some of these tools include:</p>
							        <div class="spacer-20"></div>	
									<h4 class="service-heading">HADOOP -</h4>
									<p>Kalyani IT delivers real time insight into data with Hadoop, helping organizations gain the most advantage from their historical, live and emerging unstructured data. More companies embrace Hadoop as the platform to manage their data. However the new generation of Big Data tools and techniques are overwhelming and complex. Kalyani IT helps to mitigate this complexity.</p>
							        <div class="spacer-20"></div>	
									<h4 class="service-heading">SAP HANA -</h4>
									<p>Kalyani IT has invested much into the SAP - HANA - BIG DATA space as more companies are demanding...access to data, speed to data, cost savings, resource training and management and usability for the end user. Kalyani IT designs these systems and provides this integration for organizations of all scales.</p>
							        <p>While there are other technologies available, several in which Kalyani IT has deep knowledge and expertise in, including Cloudera, Hortonworks and Apache, these technologies are in the upper quadrant of technologies that are available today for the enterprise. Ask a Kalyani IT Representatives about our BIG-DATA capabilities.</p>
