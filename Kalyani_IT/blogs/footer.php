<section id="mainfooter">
		...
		<div class="col-md-10 col-sm-10">
			<div class="col-sm-3 col-md-3">
				<ul>
					<h4 style="color:#333;">Get to Know Us</h4>
					<li><a href="http://numerictech.com/index.php">Home</a></li>
					<li><a href="http://numerictech.com/about.php">About</a></li>
					<li><a href="http://numerictech.com/index.php#services">Services</a></li>
					<li><a href="http://numerictech.com/index.php#industries">Industries</a></li>
				</ul>
			</div>
			<div class="col-sm-3 col-md-3">
				<ul><h4 style="color:#333;">External Links</h4>
					<li><a href="http://numerictech.com/careers.php">Careers</a></li>
 					<li><a href="http://numerictech.com/contact.php">Contact</a></li>
			...
			<div class="col-sm-3 col-md-3">
				   ...
				   <h4 style="color:#333;">Connect With Us</h4>
                        <li class="social-twi scl-tweet"><a href="https://twitter.com/NumericTech1">
						<i class="fa fa-twitter icon-tweet"></i></a>
                        </li>
						...
						<i class="fa fa-google fa-lg icon-in"></i></a>
                        </li>
                    </ul>
			</div>
			<div class="col-sm-3 col-md-3">
...
<!-- The Modal -->
<div id="career-myModal" class="career-modal">
  ...
  <div class="career-modal-content">
    ...
    <h3>Numeric Technologies Inc has openings for the positions</h3>
     ...
     <p>Work location is Warrenville, IL with required travel to client locationsthroughout the USA. Please mail resumes to 4200 Cantera Drive, Suite 100,Warrenville, IL 60555 (OR) e-mail to jobs@numerictech.com</p>
</div>
</div>
