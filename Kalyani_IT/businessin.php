...
<head>
    ...
    <title>Kalyani | Business Intelligence</title>
	...
	<div class="container">
		<div class="row">
			<div class="inpage_txt" id="sh-li">
				...
				<div class="col-md-12">
				<p>
					 <b> Companies that have comprehensive analytics and a way to understand them, are empowered to make better business decisions. SAP provides a comprehensive and easy-to-understand platform for companies to understand their data and leverage it to create new opportunities and significantly increase their competitive advantage. </b>
<br><br>
<b>Business Intelligence® (BI) Solutions</b>
<br><br>
Get real-time insights into your organization by leveraging the Big Data mining tools that SAP provides. Make better decisions faster by being informed with increased business intelligence tools in real-time.
				...
				<div class="col-sm-12 pt">
				<div class="col-md-6">
				<img src="img/businesintel_img1.jpg" />
				</div>
				<div class="col-md-6">
					  <p>
