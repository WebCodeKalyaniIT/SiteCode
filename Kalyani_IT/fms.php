...
<head>
    ...
    <title>Kalyani IT | SAP FMS</title>
...
?>		
	...
	<ol class="breadcrumb">
		...
		<span class="breadcrumb_last">SAP FMS</span></span></span></span>
		</li>
    </ol>
	</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="inpage_txt" id="sh-li">
				...
				<div class="col-md-12">
				<p>
					 SAP Fashion Management provides a comprehensive solution for fashion companies to:  break down barriers and inefficiencies across sales channels, increase speed of 
					 range introduction and gain up-to-the-minute visibility across all partners to expedite deliveries. 
				</p>
				</div>
				...
				<div class="col-md-offset-2 col-md-6 col-sm-12">
						...
						<b>Key Solutions:</b>
<ul>						<br><br>
<li><i class="icon-check"></i>Inventory Planning</li>
<li><i class="icon-check"></i>Single Product Master Data</li>
<li><i class="icon-check"></i>Store and E-Commerce Integration</li>
<li><i class="icon-check"></i>Real-Time Analytics</li>
<li><i class="icon-check"></i>Segmentation</li>
</ul>
						</p>			
				</div>
				<div class="col-md-4 col-sm-12">
				<img src="img/fms_img1.jpg" />
				</div>
