        ...
        <div class="container">
            <div class="intro-text" style="height:200px !important; ">
               <div class="col-xs-10">   
				...
				<br/>
				<span>Kalyani IT makes it run better!</span>
				</div>
                 </div>
            </div>
        </div>
            ...
            <div class="row text-center">
				<a href="enterprise.php" class="portfolio-link">
					<div class="col-md-4 hoverstyle standout wow fadeInLeft animated">
						...
						<p class="text-muted">Kalyani IT offers Global Enterprise Application Solutions including <b>SAP, ORACLE</b> & others</p>
				...
				<a href="sap.php" class="portfolio-link">
					<div class="col-md-4 hoverstyle standout wow fadeInLeft animated">
						...
						<p class="text-muted">“Take Advantage Of The Latest In SAP® Technology To Drive Improvement For Your Business. Kalyani IT Technologies Is An Innovative Leader In SAP® Solution Offerings And An Expert In Leveraging Them To Drive Business Processes Improvement And Company Growth.”</p>
				...
				<a href="dashboards.php" class="portfolio-link">
					<div class="col-md-4 hoverstyle standout wow fadeInRight animated">
						...
						<p class="text-muted">Kalyani IT is the industry leader in <b>Dashboards</b> providing solutions in <b>Design Studio, Tableau, Lumira </b>& Qlikview.</p>
