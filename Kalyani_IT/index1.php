    ...
    <header>
        <div class="container">
            <div class="intro-text" style="height:200px !important; ">
				...
				<br/>
				<span>and Kalyani IT makes it run better</span>
				</div>
            ...
            <div class="row text-center">
				<a href="enterprise.php" class="portfolio-link">
					<div class="col-md-4 hoverstyle standout wow fadeInLeft animated">
						...
						<p class="text-muted">Kalyani IT offers Global Enterprise Application Solutions including <b>SAP, ORACLE</b>,&nbsp SalesForce & others</p>
