		...
		<div class="col-md-12">
			...
			<div class="col-md-12">
				<p>
					...
					Numeric Technologies is an innovative leader in SAP® solution offerings and an 
			...
			<div class="clearfix effects" id="effect-5">
				...
				<div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter supply">
					<div class="img">
						...
						<div class=" overlay">
							<a href="cmr.php" class="expand glyphicon glyphicon-search"></a>
							<a class="close-overlay hidden">x</a>
						</div>
					</div>
					<img src="img/tabimg.png" class="sm-img">
