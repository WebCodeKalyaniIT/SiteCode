...
<head>
    ...
    <title>Numeric | Supply Chain </title>
...
?>		
	...
	<ol class="breadcrumb">
		...
		<span class="breadcrumb_last">Supply Chain</span></span></span></span>
		</li>
    </ol>
	</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="inpage_txt" id="sh-li">
				...
				<div class="col-md-3">
                    <br><br><br><br>
					<img src="img/Manhattan.png" class="img-responsive" alt="" />
				</div>
				<div class="col-md-9">
				<h2>Supply Chain</h2>
				<br/><br/>
				<div class="col-md-12">
				<p>
                    <b> Maximize ROI and mitigate risk with supply chain optimization solutions from <span style="color:#008cda"> Manhattan Associates</span>
                     </b>
                </p>
<br><br>
                <p>
                Manhattan Associates is a leading software provider offering supply chain optimization solutions from planning through execution. Considered a long-time leader in supply chain solutions for warehouse management, the company has evolved to offer a wide breadth of offerings across the supply chain area through its unique platform-based approach to supply chain optimization.
...
In all engagements, Numeric and Manhattan help our customers achieve long-term success through cost reduction and risk mitigation.
				</p>
				</div>
