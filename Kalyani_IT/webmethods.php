...
<head>
    ...
    <title>Numeric | WebMethods </title>
...
?>		
	...
	<ol class="breadcrumb">
		...
		<span class="breadcrumb_last">Webmethods</span></span></span></span>
		</li>
    </ol>
	</div>
	</div>
		...
		<section>
		 ...
		 <div class="col-sm-12">
				<div class="col-md-3 webimg">
					<img src="img/webmethods_img2.jpg" class="img-responsive" alt="" />
				</div>
				<div class="col-md-9">
				<h2>WebMethods</h2>
				<br/><br/>
	<p>
Numeric Technologies has partnered with Software AG to provide the most comprehensive Digital Business Platform encompassing enterprise application integration, B2B, business process management, SOA, operational intelligence, API management, in-memory data management, and analytics to meet rapid and challenging business demands. Our expertise in the cloud uniquely positions us to develop and architect right integration strategies in harmonizing on-premise middleware, 
cloud middleware, and cloud APIs to stay competitive in a global economy.
	</p>
	<br/><br/>
 
	<div class="col-md-6"></div>
	<div class="col-md-6 col-md-offset-8 pull-left">
	<div class="sh-strong"><strong>Our WebMethods services include –</strong></div>
	<br/><br/>
		<ul>
		  <li><i class="icon-check"></i>Implementation</li>
		  <li><i class="icon-check"></i>Business Case Building</li>
		  <li><i class="icon-check"></i>Application Managed Services</li>
		  <li><i class="icon-check"></i>Assessment Service</li>
		  <li><i class="icon-check"></i>Offshore Delivery</li>
